...
async function run() {
    try {
        const interpreter = getInput("interpreter");
        const packages = getInput("packages");
        const flakes = getInput("flakes");
        const flakesFromDevshell = getBooleanInput("flakes-from-devshell");
        const customDevshell = getInput("custom-devshell");
